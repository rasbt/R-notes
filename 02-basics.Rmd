...
- You may be used to referring to real numbers as floats (or doubles) in other programming languages; in R, real numbers are represented via the `numeric` data type
